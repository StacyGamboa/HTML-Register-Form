<?php
    ...
    $email_from = $email;
    $email_to = 'info@companyname'; //replace with your email
    ...
    @mail($email_from, $subject.' '.$subjectEmailFrom, 'Plan: ' . $plan . "\n\n" .'Thank you! One of our agents will contact you soon.', 'From: <'.$email_to.'>');

    @mail($email_to, 'A customer has been registered.', $body , 'From: <'.$email_to.'>');
